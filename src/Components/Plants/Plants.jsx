...
const {loader, trees} = use(TreeContext)
   ...
   if(loader){
           ...
           {trees.map(tree => <div key={tree.plantId} className="card bg-base-100 w-96 shadow-sm">
     ...
     <div className="card-body items-center text-center">
      ...
      <div className='flex justify-between items-center w-full text-[16px] font-semibold'>
       ...
       <div className="card-actions mt-2">
         <Link className='btn bg-[#344e41] text-white'>View Details</Link>
       </div>
     </div>
   </div>)}
           </div>
